<%@ Page Title="" Language="C#" MasterPageFile="~/View/Shared/Site1.Master" AutoEventWireup="true" CodeBehind="AddIngredient.aspx.cs" Inherits="FoodnStuff.View.StorageManagement.AddIngredient" %>
            ...
            <div class="col-md-offset-2 col-md-8 sub-container">
                <form id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <a onclick="Add_Onclick()">Click here to add more ingredient to storage</a>
                            </div>
                        </div>
                        <br />
